...
export const metadata = buildMetadata({
  title: "تواصل معنا",
  description:
    "اتصل بنا مباشرة أو استخدم نموذج التواصل للاستفسار عن برامج الحج والعمرة.",
  path: "/contact",
        ...
        <div className="container-shell relative">
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-white/80">
              يمكنك التواصل معنا للاستفسار عن البرامج أو طلب المساعدة في ترتيبات
              السفر.
            </p>
          </Reveal>
        </div>
          ...
          <Reveal>
            <div className="relative flex h-full flex-col overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(160deg,rgba(8,50,38,0.97),rgba(11,59,44,0.93))] p-8 text-white shadow-soft sm:p-10">
              ...
              <div className="relative">
                <p className="text-sm font-semibold text-[color:var(--color-gold-soft)]">
                  طرق التواصل السريع
                </p>
          ...
          <Reveal delay={0.12}>
            <div>
              ...
              <p className="mt-3 text-sm leading-7 text-[color:var(--color-muted)]">
                املأ النموذج التالي وسنعاود التواصل معك في أقرب وقت ممكن، أو
                استخدم أرقام الاتصال وواتساب للرد الفوري.
              </p>
              <div className="mt-6">
                <ContactForm />
              </div>
